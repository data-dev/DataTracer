...
class DataTracer():
    ...
    def fit(self, list_of_tables, list_of_pks, list_of_fks):
        self.primary_key.fit(list_of_tables, list_of_pks)
        self.foreign_key.fit(list_of_tables, list_of_pks, list_of_fks)
    ...
    def solve(self, tables):
        ...
        column_maps = self.column_map.solve(tables, primary_keys, foreign_keys)
        return {
